...
module.exports = {
    ...
    Spec: {
        ...
        "SynergyProtocol": { code: Message.Code.POST, uri: "m", type: Message.Type.NON, Response: null },
        "Attribute" : { code: Message.Code.POST, uri: 'a', type: Message.Type.NON, Response: null },
        ...
        //"GetTime": { code: Message.Code.GET, uri: "t", type: Message.Type.CON, Response: "myReturn" },
        ...
        //"myReturn": { code: Message.Code.MYTYPE, type: Message.Type.ACK },
